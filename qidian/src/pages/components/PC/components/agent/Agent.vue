	...
	<div class="agent" ref='wapper'>
		<div class="cont">
			<div class="agentMsg" @click="myMsg">
				...
				<div>
					<h2>{{data.xm}}</h2>
					<p><span>已申请办卡:<i>{{data.cardNum}}</i>张</span><span>审核通过截图:<i>{{data.throughNum}}</i>张</span></p>
				</div>
			</div>
			<div class="agentBenefits">
				<p @click="integral"><em>{{data.integral}}</em><br /><span>积分</span></p>
				<p @click="bonus" class="middleP"><em>{{data.bonus}}</em><br /><span>奖励金</span></p>
		...
		<div class="Mybenifit">
			...
			<p class="iconfont handleP" @click="benefits"><span><img src="../../../../../assets/image/PC (5).png"/>代理人权益</span><span class="iconfont"><img class="right" src="../../../../../assets/image/PC (2).png" /></span></p>
